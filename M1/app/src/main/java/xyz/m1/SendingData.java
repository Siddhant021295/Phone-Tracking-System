...
public class SendingData extends AppCompatActivity {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               textView_lat.setText(CurLat);
                ...
                GetXMLTask task = new GetXMLTask();
                task.execute(new String[] {"http://192.168.43.172:8080/phone_tracking_system/GetLocation?number1="+CurLat+"&number2="+Curlongi+"&PID="+PID });
                Log.i("pid",PID);
            }
        });
    }
    ...
    private class GetXMLTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String output) {
            textView_Status.setText(output);
        }
    }
}